...
|---|---|---|
| Frontend | HTML / CSS / JavaScript | Interface responsiva e dinâmica |
| Backend | Node.js / Java | API robusta e escalável |
| Banco de Dados | MySQL | Armazenamento seguro de usuários e logs |
| Segurança | Criptografia AES-256 / JWT (JSON Web Tokens)| Autenticação e criptografia de dados |
